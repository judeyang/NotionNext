...
const BLOG = {
// Important page_id！！！Duplicate Template from  [https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5](https://www.notion.so/02ab3b8678004aa69e9e415905ef32a5?pvs=21)
NOTION_PAGE_ID:
...
GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '活得开心点',

CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Jude', // 您的昵称 例如 tangly1024
BIO: process.env.NEXT_PUBLIC_BIO || '快乐的技术', // 作者简介
LINK: process.env.NEXT_PUBLIC_LINK || '[https://judeyang.com](https://judeyang.com/)', // 网站地址
KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '快乐, Notion, 博客', // 网站关键词 英文逗号隔开
...
NOTION_HOST: process.env.NEXT_PUBLIC_NOTION_HOST || '[https://www.notion.so](https://www.notion.so/)', // Notion域名，您可以选择用自己的域名进行反向代理，如果不懂得什么是反向代理，请勿修改此项
...
RANDOM_IMAGE_REPLACE_TEXT: process.env.NEXT_PUBLIC_RANDOM_IMAGE_NOT_REPLACE_TEXT || '[images.unsplash.com](http://images.unsplash.com/)', // 触发替换图片的 url 关键字(多个支持用英文逗号分开)，只有图片地址中包含此关键字才会替换为上方随机图片url
// eg: [images.unsplash.com](http://images.unsplash.com/)(notion图床的所有图片都会替换),如果你在 notion 里已经添加了一个随机图片 url，恰巧那个服务跑路或者挂掉，想一键切换所有配图可以将该 url 配置在这里
...
// 支援類似 WP 可自訂文章連結格式的功能：[https://wordpress.org/documentation/article/customize-permalinks/，目前只先實作](https://wordpress.org/documentation/article/customize-permalinks/%EF%BC%8C%E7%9B%AE%E5%89%8D%E5%8F%AA%E5%85%88%E5%AF%A6%E4%BD%9C) %year%/%month%/%day%
...
WEB_WHIZ_BASE_URL: process.env.NEXT_PUBLIC_WEB_WHIZ_BASE_URL || '[https://api.webwhiz.ai](https://api.webwhiz.ai/)', // 可以自建服务器
...
COMMENT_CUSDIS_HOST:
process.env.NEXT_PUBLIC_COMMENT_CUSDIS_HOST || '[https://cusdis.com](https://cusdis.com/)', // data-host, change this if you're using self-hosted version
...
COMMENT_TIDIO_ID: process.env.NEXT_PUBLIC_COMMENT_TIDIO_ID || '', // [tidio_id] -> [//code.tidio.co/[tidio_id].js](notion://code.tidio.co/%5Btidio_id%5D.js)

COMMENT_VALINE_CDN: process.env.NEXT_PUBLIC_VALINE_CDN || 'https://unpkg.com/valine@1.5.1/dist/Valine.min.js',
COMMENT_VALINE_APP_ID: process.env.NEXT_PUBLIC_VALINE_ID || '', // Valine @see https://valine.js.org/quickstart.html 或 [https://github.com/stonehank/react-valine#获取app-id-和-app-key](https://github.com/stonehank/react-valine#%E8%8E%B7%E5%8F%96app-id-%E5%92%8C-app-key)
...
ANALYTICS_BAIDU_ID: process.env.NEXT_PUBLIC_ANALYTICS_BAIDU_ID || '', // e.g 只需要填写百度统计的id，[baidu_id] -> [https://hm.baidu.com/hm.js?[baidu_id](https://hm.baidu.com/hm.js?%5Bbaidu_id)]
ANALYTICS_CNZZ_ID: process.env.NEXT_PUBLIC_ANALYTICS_CNZZ_ID || '', // 只需要填写站长统计的id, [cnzz_id] -> [https://s9.cnzz.com/z_stat.php?id=[cnzz_id]&web_id=[cnzz_id]](https://s9.cnzz.com/z_stat.php?id=%5Bcnzz_id%5D&web_id=%5Bcnzz_id%5D)
...
ANALYTICS_ACKEE_DATA_SERVER: process.env.NEXT_PUBLIC_ANALYTICS_ACKEE_DATA_SERVER || '', // e.g [https://ackee.tangly1024.com](https://ackee.tangly1024.com/) , don't end with a slash
