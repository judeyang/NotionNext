...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Yo～Jude', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '生活，而非活着 ', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://juddeyang.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '生活, 博客, 笔记', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    '专注行业13载, 您可靠的教育信息化解决方案提供商, 让创新连接每一处🎉',
